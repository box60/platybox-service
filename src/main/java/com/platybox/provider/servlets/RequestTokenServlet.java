...
public class RequestTokenServlet extends HttpServlet {
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // generate request_token and secret and persist callback_url
            HashMap <String,String> freshToken 
            				= OAuthProvider.generateRequestToken(accessor, requestMessage);
            
            String newToken = freshToken.get("token");
            String newSecret = freshToken.get("secret");
                        
            response.setContentType("text/plain");
            OutputStream out = response.getOutputStream();
            OAuth.formEncode(OAuth.newList("oauth_token", newToken,
                                           "oauth_token_secret", newSecret), //TODO: REMOVE
                             out);
            out.close();

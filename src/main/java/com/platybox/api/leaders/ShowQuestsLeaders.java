 ...
 */
@Controller
public class ShowQuestsLeaders extends HttpServlet {
	
	@RequestMapping(value="/leaders/quests", method=RequestMethod.POST)
	public @ResponseBody LeadersModel showQuestsLeaders( HttpServletRequest request,
		...
		try {
            ...
            return LeadersModel.searchQuestsLeaders();            
        } catch (Exception e){

 ...
 */
@Controller
public class DestroyFriends extends HttpServlet {	

	@RequestMapping(value="/friends/destroy", method=RequestMethod.POST)	
	public @ResponseBody FriendsModel destroy(HttpServletRequest request,
		 ...
		 try{
             ...
             if (users_id.equals(friend_users_id) == false) { //avoid narcisism	             
            	 return FriendsModel.deleteFriend(users_id, friend_users_id);            	    
	         }            
         } catch (Exception e){

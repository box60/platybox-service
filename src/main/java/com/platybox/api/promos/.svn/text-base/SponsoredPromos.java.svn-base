 ...
 */
@Controller
public class SponsoredPromos extends HttpServlet {
	
	@RequestMapping(value="/promos/sponsored", method=RequestMethod.GET)	
	public @ResponseBody PromosModel showBits(	HttpServletRequest request,
											HttpServletResponse response)	
											throws IOException, ServletException {
		
	  return PromosModel.searchSponsoredPromos();              
    }

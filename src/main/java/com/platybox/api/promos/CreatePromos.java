...
import com.platybox.utils.PromosUtils;
...
/*
 *
 * Create a promo, if no dtstart is provided, promo will have a dtstart of today until ever.
 * 
 * dtstart and dtend in the form: "20110310" TODO: implement form 20110101T134520Z
 * rrule, a semicolon-separated rrule in the form: RRULE:FREQ=WEEKLY;COUNT=10;BYMONTH=6,7;BYHOUR=9,10,11,12,13,14,15,16;BYDAY=MO,WE,FR [finest grain is hour, if badly formatted the promo will be returned anyways.]
 * rdatelist: a coma-separated list of dates in the form: "20110310,20110310,20110310" TODO: implement form 20110101T134520Z 
 * 
 * 
 * if rdatelist provided, they will be from 0 to 24 hours. for a whole day.
 *  
 * for more info visit http://www.ietf.org/rfc/rfc2445.txt
 * 
 * Example response:
...
@Controller
public class CreatePromos extends HttpServlet {

	@RequestMapping(value="/promos/create", method=RequestMethod.POST)	
	public @ResponseBody PromosModel showBits(	HttpServletRequest request,
    	 ...
    	 try{
             ...
             //let's create the schedule for this promo
             //http://google-rfc-2445.googlecode.com/svn/truk/snapshot/docs/index.html
             //if null parameters are passed 
             String users_id = String.valueOf(DatabaseUtils.getUserId(accessor));
             if (name!=null && description != null && price!= null) 
            	 PromosUtils.createPromo(users_id, name, description, expires, price, places_id, dtstart, dtend, rrule, rdatelist);

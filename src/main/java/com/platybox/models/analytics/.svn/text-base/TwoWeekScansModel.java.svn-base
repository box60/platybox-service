...
public final class TwoWeekScansModel {
	...
	private static final TwoWeekScansModel AVAILABLE_INSTANCE = new TwoWeekScansModel(
			null, null);


	public TwoWeekScansModel(ArrayList<HashMap<String,String>> cols, ArrayList<HashMap<String,ArrayList<HashMap<String,Object>>>> rows) {		
		this.cols = cols;
		this.rows = rows;
	}
	...
	public static TwoWeekScansModel showTwoWeekScans (String places_id) {
		...
		return new TwoWeekScansModel(cols, rows);
				
	}
	
	public static TwoWeekScansModel error() {
